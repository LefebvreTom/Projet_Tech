...
vector<string> IA::vecteurBranche(int id){
    ...
    //Aucune modif ouvrier
        ...
        if(partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(1)-1,6)!=""){
            succ.push_back("de1a0" + partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(1)-1,6)); //le d� 1 non modifi� permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(1)-1,7)!=""){
            succ.push_back("de1a0" + partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(1)-1,7)); //le d� 1 non modifi� permet l'achat de la case 2
        }
        if(partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(2)-1,6)!=""){

            succ.push_back("de2a0" + partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(2)-1,6)); //le d� 2 non modifi� permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(2)-1,7)!=""){
            succ.push_back("de2a0" + partie.getMarche().getTuileMarche(partie.getJoueur(id).getde(2)-1,7)); //le d� 2 non modifi� permet l'achat de la case 2
        }
        //poser une des cases
        for(int i=0;i<3;i++){
    ...
    if(partie.getJoueur(id).getOuvrier()>=1){
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de1aplus1" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 1 +1 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de1aplus1" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 1 +1 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de1pplus1r" + std::to_string(i) + "case" + std::to_string(j)); // d� 1 +1 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de1amoins1" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 1 -1 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de1amoins1" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 1 -1 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de1pmoins1r" + std::to_string(i) + "case" + std::to_string(j)); // d� 1 -1 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de2aplus1" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 2 +1 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de2aplus1" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 2 +1 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de2pplus1r" + std::to_string(i) + "case" + std::to_string(j)); // d� 2 +1 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de2amoins1" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 2 -1 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de2amoins1" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 2 -1 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de2pmoins1r" + std::to_string(i) + "case" + std::to_string(j)); // d� 2 -1 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
    ...
    if(partie.getJoueur(id).getOuvrier()>=2){
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de1aplus2" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 1 +2 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de1aplus2" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 1 +2 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de1pplus2r" + std::to_string(i) + "case" + std::to_string(j)); // d� 1 +2 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de1amoins2" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 1 -2 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de1amoins2" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 1 -2 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de1pmoins2r" + std::to_string(i) + "case" + std::to_string(j)); // d� 1 -2 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de2aplus2" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 2 +2 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de2aplus2" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 2 +2 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de2pplus2r" + std::to_string(i) + "case" + std::to_string(j)); // d� 2 +2 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de2amoins2" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 2 -2 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de2amoins2" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 2 -2 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de2pmoins2r" + std::to_string(i) + "case" + std::to_string(j)); // d� 2 -2 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
    ...
    if(partie.getJoueur(id).getOuvrier()>=3){
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de1aplus3" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 1 +3 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de1aplus3" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 1 +3 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de1pplus3r" + std::to_string(i) + "case" + std::to_string(j)); // d� 1 +3 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de1amoins3" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 1 -3 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de1amoins3" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 1 -3 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de1pmoins3r" + std::to_string(i) + "case" + std::to_string(j)); // d� 1 -3 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }*/
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de2aplus3" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 2 +3 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de2aplus3" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 2 +3 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de2pplus3r" + std::to_string(i) + "case" + std::to_string(j)); // d� 2 +3 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }
        ...
        if(partie.getMarche().getTuileMarche(de-1,6)!=""){
            succ.push_back("de2amoins3" + partie.getMarche().getTuileMarche(de-1,6)); //le d� 2 -3 permet l'achat de la case 1
        }
        if(partie.getMarche().getTuileMarche(de-1,7)!=""){
            succ.push_back("de2amoins3" + partie.getMarche().getTuileMarche(de-1,7)); //le d� 2 -3 permet l'achat de la case 2
        }
        for(int i=0;i<3;i++){
            if(partie.getJoueur(id).getReserve(i).compare("")!=0){
                for(int j=0;j<37;j++){
                    if(simulateur.testPosageTuile(partie.getJoueur(id), de-1, i, j)){
                        succ.push_back("de12pmoins3r" + std::to_string(i) + "case" + std::to_string(j)); // d� 2 -3 pose la tuile i du reservoir sur la case j
                    }
                }
            }
        }*/
